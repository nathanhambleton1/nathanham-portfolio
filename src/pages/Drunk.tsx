...
import PartnerTournament from "../../drunk/pages/BeerBall";
  ...
  return (
    <div className="min-h-screen">
      <Routes>
        ...
        <Route path="partner-tournament" element={<PartnerTournament />} />
        <Route path="beer-ball" element={<PartnerTournament />} />
